            ...
            <div className="absolute bottom-20 right-0 w-80 bg-white rounded-lg shadow-xl border">
                ...
                <div className="p-4 border-t">
                    <div className="flex space-x-2">
                        <input value={question} onChange={(e) => { setQuestion(e.target.value) }} type="text" placeholder="Type your question..." className="flex-1 border rounded-lg px-3 py-2 text-black dark:text-white bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" onKeyPress={handleChatKeyPress}></input>
